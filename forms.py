...
class OrderForm(FormsetForm, DiscountForm):
    ...
    class Meta:
        ...
        labels = {"billing_detail_state": _("Province"),
                  "billing_detail_city": _("City/Town"), "billing_detail_street": _("Street & Suburb"),
                  "billing_detail_postcode":_("Postal Code"),
                  "shipping_detail_state": _("Province"),
                  "shipping_detail_city": _("City/Town"), "shipping_detail_street": _("Street & Suburb"),
                  "shipping_detail_postcode":_("Postal Code"),}
        widgets = {"billing_detail_city": forms.Select(choices=AVAILABLE_CITIES),
                   "billing_detail_state": forms.Select(choices=AVAILABLE_PROVINCES),
                   "billing_detail_country": forms.Select(choices=AVAILABLE_COUNTRIES),
                   "shipping_detail_city": forms.Select(choices=AVAILABLE_CITIES),
                   "shipping_detail_state": forms.Select(choices=AVAILABLE_PROVINCES),
                   "shipping_detail_country": forms.Select(choices=AVAILABLE_COUNTRIES),}
